...
class CustomBigInteger{
    ...
    public CustomBigInteger divide(CustomBigInteger divisor) {
        ...
        while (quotient.digits.length > 1 && quotient.digits[0] == 0) {
            quotient.digits = Arrays.copyOfRange(quotient.digits, 1, quotient.digits.length);
        }
    ...
    public int compareTo(CustomBigInteger other) {
        if (this.isResultNegative != other.isResultNegative) {
            return this.isResultNegative ? -1 : 1;
        }
    
        if (this.digits.length != other.digits.length) {
            return this.isResultNegative ? 
...
public class Union{
    public static void main(String[] args) {
         ...
         System.out.println(new CustomBigInteger("0").subtract(new CustomBigInteger("0"))); // 0
         ...
         System.out.println(new CustomBigInteger("00").divide(new CustomBigInteger("500"))); // 1
